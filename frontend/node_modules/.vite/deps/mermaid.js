...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-I6XJVG4X-7VTXXJTN.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-PVQCEYII-SJI36YDB.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-5YYISTIA-IUA2G2KP.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-4H26LBE5-2JW6SMAH.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-3UESZ5HK-XYZZXCTR.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-UN3LZRKU-NF5PXGJQ.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-LMA3HP47-75AUWEX6.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-2AECGRRQ-NEKAUBBA.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-5GNKFQAL-7PRNJFAZ.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-3BPJPVTR-KAZRKRLL.js");
...
var loader28 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-KO2AKTUF-DI5IAXE7.js");
...
var loader31 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-OG6HWLK6-JGU5VSYG.js");
...
var loader32 = __name(async () => {
  const { diagram: diagram2 } = await import("./wardleyDiagram-YWT4CUSO-2MRGFD5T.js");
